...
export class PasswordController {
  ...
  async resetPassword(
    ...
    try {
      await this.passwordService.resetPassword(dto.email, dto.password, dto.token, res);
  ...
  async changePassword(
    @GetCurrentUserId() userId: UserIdDto,
    ...
    try {
      ...
      await this.passwordService.changePassword(userId, dto.oldPassword, dto.newPassword);
