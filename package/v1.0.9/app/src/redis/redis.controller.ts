...
export class RedisController {
  ...
  @ApiQuery({ name: 'key', required: true, description: 'The key to retrieve from Redis' })
  @ApiResponse({ status: 200, description: 'The value associated with the key' })
  ...
  @ApiQuery({ name: 'key', required: true, description: 'The key to delete from Redis' })
