...
export function ApiDocReady(port: string | number, configService: ConfigService) {
  Logger.verbose(`Doc available at http://localhost:${port}/${configService.get('API_DOC_URL')}`);
}
