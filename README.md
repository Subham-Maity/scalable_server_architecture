...
#### 📌 [Version 1.0.8](package/v1.0.8/documentation/README.md) - `focus`: redis setup with testing and using in auth otp + user gets, rate limit, helmet setup,token blacklist, error handling and auth documentation